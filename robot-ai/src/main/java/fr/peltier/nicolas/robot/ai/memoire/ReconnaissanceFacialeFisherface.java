package fr.peltier.nicolas.robot.ai.memoire;
 ...
 */
public class ReconnaissanceFacialeFisherface extends ReconnaissanceFaciale {
    ...
    /** Logger. */
    private Logger logger = Logger.getLogger(ReconnaissanceFacialeFisherface.class);
