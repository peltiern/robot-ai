...
import fr.peltier.nicolas.robot.ai.decisionnel.Cerveau;
import fr.peltier.nicolas.robot.ai.organes.actionneurs.OrganeParole;
import fr.peltier.nicolas.robot.ai.organes.actionneurs.OrganeParole3;
import fr.peltier.nicolas.robot.ai.organes.actionneurs.Tete;
import fr.peltier.nicolas.robot.ai.organes.capteurs.CapteurVision;
import fr.peltier.nicolas.robot.ai.organes.capteurs.CapteurVocal;
import fr.peltier.nicolas.robot.ai.organes.capteurs.CapteurVocal3;
...
import fr.peltier.nicolas.robot.ai.systemenerveux.event.StopEvent;
...
//    private CapteurVocal2 capteurVocal;
    ...
    private void initialiser() {
        ...
        systemeNerveux = new MBassador<RobotEvent>(BusConfiguration.Default());
